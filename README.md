...
<h1>Hi there, I'm Abdiel 👋</h1>
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?font=Roboto&weight=900&duration=2500&pause=1000&color=FF3131&center=true&vCenter=true&width=500&lines=AI+Engineer+%26+RAG+Specialist;Full-Stack+Software+Architect;Bioinformatics+%26+Automation;Python+%7C+LangChain+%7C+n8n" /></a>

<img src="Captura de pantalla (37).png" alt="Abdiel Setup" width="100%" style="border-radius: 10px;">
</div>

## 👨‍💻 About Me:
- 🔭 I’m currently working as an **AI Engineer & RAG Specialist** at **Guajiritos**, building production-grade multi-agent systems and automation workflows.
- 🎓 **4th year Software Engineering** student at "Ciudad Universitaria José Antonio Echeverría" (CUJAE).
- 🧠 Specialized in **Retrieval-Augmented Generation (RAG)**, **LLM Orchestration**, and **Computer Vision**.
- 💼 Strong background in **Full-Stack Development** (Spring, Angular, NestJS, VueJS).
- 🌱 Currently researching **Federated Learning** and **Bioinformatics algorithm** for protein interaction.
- 🤝 Open to collaborations on **AI Agents**, **Automation**, and **Open Source AI projects**.

## 💼 Professional Experience:

### 🤖 AI Engineer | RAG & Automation Specialist - Guajiritos
*(Jan 2026 - Present)*
- Designing **RAG architectures** to enhance LLM outputs with proprietary business data.
- Orchestrating **Multi-Agent Systems** and MCP-based workflows for complex task execution.
- Building scalable automations using **n8n**, Python, and Vector Databases.
- Technologies: Python, LangChain, n8n, Vector DBs, REST APIs.

### 🧬 Bioinformatics Software Engineer - CIGB (Freelance)
*(Sep 2025 - Present)*
- Designed a quantitative scoring algorithm to evaluate **protein-protein interactions** (Dengue virus vs. LRP1).
- Developed a web-based analytical platform integrating the custom scoring engine.
- Technologies: Python, Algorithm Design, Angular 18+, TypeScript.

### 🛡️ Full Stack Developer - INTRUST SECURITY
*(Dec 2025 - Jan 2026)*
- Developed a vulnerability management platform and automated security scanning tools.
- Integrated multiple security tools into a unified risk analysis dashboard.
- Technologies: Spring Boot, Angular, PostgreSQL, Go, Liquibase.
...
![YOLO](https://img.shields.io/badge/YOLO-Ultralytics-00FFFF?style=for-the-badge)
...
<a href="mailto:abdielr10330@gmail.com" target="blank"><img align="center" src="https://mailmeteor.com/logos/assets/PNG/Gmail_Logo_512px.png" height="28" width="35" /></a>
